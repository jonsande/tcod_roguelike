...
PLAYER_STARTING_INVENTORY = [
    ...
    #{"item": "blessed_identify_scroll", "quantity": 2},
...
ALL_ITEMS = [
    ...
    ("paralisis_scroll", 7),
    ("identify_scroll", 8),
    ("blessed_identify_scroll", 5),
    ("remove_curse_scroll", 7),
    ("lightning_scroll", 6),
    ("fireball_scroll", 5),
    ("descend_scroll", 6),
    ("teleport_scroll", 6),
    ("prodigious_memory_scroll", 4),
    ("chain_mail", 1),
    ("leather_armor", 8),
    ("cloak", 5),
    ("small_shield", 4),
...
ITEM_SPAWN_RULES = {
    ...
    # WEAPONS
    "short_sword": {"min_floor": 2, "max_instances": 2, "weight_progression": [(2, 2), (4, 5)]},
    "short_sword_plus": {"min_floor": 6, "max_instances": 1, "weight_progression": [(6, 5)]},
    "long_sword": {"min_floor": 2, "max_instances": 2, "weight_progression": [(2, 1), (7, 5)]},
    "long_sword_plus": {"min_floor": 7, "max_instances": 1, "weight_progression": [(7, 1)]},
    "spear": {"min_floor": 2, "max_instances": 2, "weight_progression": [(2, 1), (5, 5), (7, 10)]},
    "spear_plus": {"min_floor": 7, "max_instances": 1, "weight_progression": [(5, 1), (7, 2)]},
    "long_bow": {"min_floor": 2, "max_instances": 2, "weight_progression": [(2, 5)]},
    ...
    "blessed_identify_scroll": {"min_floor": 3, "min_instances": 2, "max_instances": 2, "weight_progression": [(6, 4)]},
    ...
    # ARMOR
    "chain_mail": {"min_floor": 5, "max_instances": 1, "weight_progression": [(5, 3)]},
    "leather_armor": {"min_floor": 2, "weight_progression": [(2, 3)]},
    "cloak": {"min_floor": 2, "max_instances": 3, "weight_progression": [(2, 3)]},
    # OFFHAND
    "small_shield": {"min_floor": 2, "max_instances": 1, "weight_progression": [(2, 3)]},
    "medium_shield": {"min_floor": 4, "max_instances": 1, "weight_progression": [(4, 3)]},
    "large_shield": {"min_floor": 6, "max_instances": 1, "weight_progression": [(6, 3)]},
    # HEADARMOR
    "leather_cap": {"min_floor": 2, "weight_progression": [(2, 5)]},
    "scout_hood": {"min_floor": 2, "max_instances": 3, "weight_progression": [(2, 4)]},
    "iron_helmet": {"min_floor": 2, "max_instances": 3, "weight_progression": [(2, 4)]},
    "orcish_war_helm": {"min_floor": 3, "weight_progression": [(2, 4)]},
    # RINGS
    "accuracy_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    "plain_ring": {"min_floor": 4, "min_instances": 1, "max_instances": 8, "weight_progression": [(4, 5)]},
    "strength_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    "farsight_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    "vigor_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    "antidote_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    "memory_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    "recovery_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    "guard_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    "fortune_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    "cursed_weakness_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    "cursed_myopia_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    "cursed_fatigue_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    #"cursed_lethargy_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2), (6, 5)]},
    "cursed_vulnerability_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    "cursed_misfortune_ring": {"min_floor": 4, "min_instances": 0, "max_instances": 1, "weight_progression": [(4, 2)]},
    # OTHER
    "bones": {"min_floor": 2, "weight_progression": [(2, 90), (4, 20), (6, 10)]},
    "rock": {"min_floor": 2, "weight_progression": [(2, 15), (3, 45)]},
    "stone": {"min_floor": 1, "weight_progression": [(2, 15)]},
...
ENEMY_SPAWN_RULES = {
    ...
    "slime": {"min_floor": 2, "weight_progression": [(2, 10), (3, 15), (5, 10)]},
    "snake": {"min_floor": 2, "weight_progression": [(2, 25), (2, 15), (4, 10), (8, 0)]},
